...
class NoticeBoardController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('manager.notice.index',['notice_boards'=>$notice_boards]);
    }
    ...
    public function create()
    {
        ...
        return view('manager.notice.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('/manager/notice')->with('success','Your Post as been submited!');
   ...
   /*-----Notice Board UPDATE Called This POST Route-----*/
    ...
    public function update(Request $request)
    {
        ...
        if ($validator->fails()) {
            Alert::error('Oops!','The Notice Boards Field Is Required Only Minimum 4 Character Allow,Duplicate Values Are Not Allow');
            return redirect('manager-notice-index')
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect('manager/notice')->with('salary','Notice Boards Deleted Successfully');
    }
}
