...
class EventController extends Controller
{
    ...
    {
        return view('manager.events.create', compact('date'));
    }
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('manager/events')->with('success','Your Post as been submited!');
        }
     ...
     public function edit($id)
    {
        ...
        return view('manager.events.edit')->with('event', $event);
    }
