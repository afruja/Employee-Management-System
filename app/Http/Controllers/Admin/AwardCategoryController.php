...
class AwardCategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        if ($validator->fails()) {
            ...
            return redirect('admin/award_categories')
            ...
            return redirect('admin/award_categories')->with('success','Your Post as been submited!');
    ...
    public function destroy(Request $request)
    {
        ...
        return redirect('admin/award_categories')->with('award','Award Category Deleted Successfully');
    }
}
