...
<div class="container-fluid" id="container-wrapper">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Pay Salary Page</h1>
        <ol class="breadcrumb">
                        ...
                        @forelse($payments as $payment)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ url('admin/payment/') }}/{{ $payment->id }}">
                                        <button type="button" class="btn btn-success"><li class="far fa-eye">Salary Slip</li></button></a>
                                </td>
                            </tr>
                        @empty
                            <tr>
