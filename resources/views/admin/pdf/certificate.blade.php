...
<div class="second-div">
    ...
    <span class="second-span"><b>This certificate is awarded to</b></span>
      ...
      <h1 class="h1">{{ $give_awards->user->name}}</h1>

      <h2 class="h2">{{ $give_awards->awardCategory->award_category}}<h2>

      <p>{{ $give_awards->awardCategory->award_description}}</p>
