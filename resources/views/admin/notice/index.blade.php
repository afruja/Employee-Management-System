      ...
      <div class="modal-content">
          <div class="modal-header">
            ...
            <div class="modal-body">
              ...
              <textarea name="notice_description" id="notice_description" class="form-control  mb-3" type="text" placeholder="Update Notice Description"></textarea>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <form action="{{url('admin/notice/destroy')}}" method="POST" enctype="multipart/form-data">
                  @csrf()
                  @method('DELETE')
                    <div class="modal-body">
                      <input type="hidden" name="notice_id" id="notice_id">
