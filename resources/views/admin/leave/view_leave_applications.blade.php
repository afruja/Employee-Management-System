  ...
  <!-- Container Fluid-->
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Leave Application Page</h1>
            <ol class="breadcrumb">
                        ...
                        @foreach($leaves as $leave)
                            <tr>
                                ...
                                <td>@if($leave->status == 'Pending')
                                    <a href="{{ url('admin/leave/'.$leave->id.'/edit?status=Accepted') }}" class="btn btn-sm btn-primary">Accept</a>
                                    <a href="{{ url('admin/leave/'.$leave->id.'/edit?status=Rejected') }}" class="btn btn-sm btn-danger">Reject</a>
